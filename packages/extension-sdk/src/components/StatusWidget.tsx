...
export interface StatusWidgetProps extends Partial<PanelProps> {
  defaultExtensionName?: string;
}

export function StatusWidget({ sdk, extensionName, defaultExtensionName = '' }: Readonly<StatusWidgetProps>) {
