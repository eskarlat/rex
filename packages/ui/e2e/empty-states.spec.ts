...
test.describe('Empty States', () => {
  ...
  test('marketplace active tab shows empty message', async ({ page }) => {
    ...
    await expect(
      page.getByText('No active extensions in this project.'),
    ).toBeVisible();
  });
  ...
  test('marketplace installed tab shows empty message', async ({ page }) => {
    ...
    await expect(
      page.getByText('No installed extensions.'),
    ).toBeVisible();
  });
  ...
  test('marketplace available tab shows empty message', async ({ page }) => {
    ...
    await expect(
      page.getByText('No available extensions in registries.'),
    ).toBeVisible();
  });
  ...
  test('extension settings shows no config message', async ({ page }) => {
    ...
    await expect(
      page.getByText('No configuration available for this extension.'),
    ).toBeVisible();
  });
