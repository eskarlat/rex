...
function FormField({ label, error, children, className }) {
  return /* @__PURE__ */ jsxs("div", { className: cn("space-y-2", className), children: [
    /* @__PURE__ */ jsx("label", { className: "text-sm font-medium leading-none", children: label }),
    children,
...
function Context7Panel({ sdk, extensionName }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-4", children: [
    /* @__PURE__ */ jsx(Panel, { title: "Context7", description: "Library documentation lookup via Context7 MCP server.", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5 text-xs text-muted-foreground", children: [
      /* @__PURE__ */ jsx("span", { className: "inline-block h-2 w-2 rounded-full bg-green-500" }),
      "MCP stdio transport"
    ] }) }),
    /* @__PURE__ */ jsx(Panel, { title: "Search Library", children: /* @__PURE__ */ jsx("div", { className: "flex flex-col gap-3", children: /* @__PURE__ */ jsx(FormField, { label: "Library Name", children: /* @__PURE__ */ jsxs("div", { className: "flex gap-2", children: [
      /* @__PURE__ */ jsx(
        "input",
        {
          type: "text",
      ...
      /* @__PURE__ */ jsx(
        "button",
        {
          ...
          children: loading && libraries.length === 0 ? "Searching..." : "Search"
        }
      )
    ] }) }) }) }),
    libraries.length > 0 && /* @__PURE__ */ jsx(Panel, { title: "Select Library", children: /* @__PURE__ */ jsx("div", { className: "flex flex-col gap-2", children: libraries.map((lib) => /* @__PURE__ */ jsxs(
      "button",
      {
        onClick: () => setSelectedId(lib.libraryId),
        className: `flex flex-col gap-1 rounded-md border p-3 text-left text-sm transition-colors ${selectedId === lib.libraryId ? "border-primary bg-primary/5" : "border-input hover:bg-accent"}`,
        children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
            /* @__PURE__ */ jsx("span", { className: "font-medium", children: lib.title }),
            /* @__PURE__ */ jsx("code", { className: "text-xs text-muted-foreground", children: lib.libraryId })
          ] }),
          /* @__PURE__ */ jsx("span", { className: "text-xs text-muted-foreground line-clamp-1", children: lib.description })
        ]
      },
      lib.libraryId
    )) }) }),
    selectedId && /* @__PURE__ */ jsx(Panel, { title: "Query Documentation", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-3", children: [
      /* @__PURE__ */ jsxs("p", { className: "text-xs text-muted-foreground", children: [
        "Library: ",
        /* @__PURE__ */ jsx("code", { className: "rounded bg-muted px-1.5 py-0.5", children: selectedId })
      ] }),
      /* @__PURE__ */ jsx(FormField, { label: "Query", children: /* @__PURE__ */ jsxs("div", { className: "flex gap-2", children: [
        /* @__PURE__ */ jsx(
          "input",
          {
            type: "text",
        ...
        /* @__PURE__ */ jsx(
          "button",
          {
            ...
            children: loading ? "Loading..." : "Query Docs"
          }
        )
      ] }) }),
      docs && /* @__PURE__ */ jsx(CodeBlock, { code: docs })
    ] }) }),
    ...
    history.length > 0 && /* @__PURE__ */ jsx(Panel, { title: "Recent Searches", children: /* @__PURE__ */ jsx("div", { className: "flex flex-col gap-1.5", children: history.map((entry) => /* @__PURE__ */ jsxs(
      "button",
      {
        ...
        children: [
          /* @__PURE__ */ jsx("span", { children: entry.libraryName }),
          /* @__PURE__ */ jsx("code", { className: "text-xs text-muted-foreground", children: entry.libraryId })
        ]
      },
      entry.libraryName
    )) }) })
