...
function GitHubPanel({ sdk, extensionName }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-4", children: [
    /* @__PURE__ */ jsx(Panel, { title: "GitHub", description: "GitHub integration via official MCP server.", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5 text-xs text-muted-foreground", children: [
      /* @__PURE__ */ jsx("span", { className: "inline-block h-2 w-2 rounded-full bg-green-500" }),
      "MCP stdio transport"
    ] }) }),
    /* @__PURE__ */ jsx(Panel, { title: "Search Repositories", children: /* @__PURE__ */ jsx("div", { className: "flex flex-col gap-3", children: /* @__PURE__ */ jsx(FormField, { label: "Repository", children: /* @__PURE__ */ jsxs("div", { className: "flex gap-2", children: [
      /* @__PURE__ */ jsx(
        "input",
        {
          type: "text",
      ...
      /* @__PURE__ */ jsx(
        "button",
        {
          ...
          children: loading && repositories.length === 0 ? "Searching..." : "Search"
        }
      )
    ] }) }) }) }),
    repositories.length > 0 && /* @__PURE__ */ jsxs(Panel, { title: "Repositories", children: [
      /* @__PURE__ */ jsx("div", { className: "flex flex-col gap-2", children: repositories.map((repo) => /* @__PURE__ */ jsxs(
        "button",
        {
          onClick: () => setSelectedRepo(repo.name),
          className: `flex flex-col gap-1 rounded-md border p-3 text-left text-sm transition-colors ${selectedRepo === repo.name ? "border-primary bg-primary/5" : "border-input hover:bg-accent"}`,
          children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
              /* @__PURE__ */ jsx("span", { className: "font-medium", children: repo.name }),
              /* @__PURE__ */ jsxs("span", { className: "text-xs text-muted-foreground", children: [
                repo.stargazers_count.toLocaleString(),
                " stars"
              ] })
            ] }),
            /* @__PURE__ */ jsx("span", { className: "text-xs text-muted-foreground line-clamp-1", children: repo.description })
          ]
        },
        repo.name
      )) }),
      selectedRepo && /* @__PURE__ */ jsx("div", { className: "mt-3", children: /* @__PURE__ */ jsx(
        "button",
        {
          ...
          children: loading ? "Loading..." : "View Issues"
        }
      ) })
    ] }),
    issues.length > 0 && /* @__PURE__ */ jsx(Panel, { title: `Issues \u2014 ${selectedRepo ?? ""}`, children: /* @__PURE__ */ jsx("div", { className: "flex flex-col gap-1.5", children: issues.map((issue) => /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsx(
              "span",
              {
                className: `inline-block h-2 w-2 rounded-full ${issue.state === "open" ? "bg-green-500" : "bg-purple-500"}`
              }
            ),
            /* @__PURE__ */ jsx("span", { children: issue.title })
          ] }),
          /* @__PURE__ */ jsxs("code", { className: "text-xs text-muted-foreground", children: [
            "#",
            issue.number
          ] })
        ]
    ...
    history.length > 0 && /* @__PURE__ */ jsx(Panel, { title: "Recent Searches", children: /* @__PURE__ */ jsx("div", { className: "flex flex-col gap-1.5", children: history.map((entry) => /* @__PURE__ */ jsxs(
      "button",
      {
        ...
        children: [
          /* @__PURE__ */ jsx("span", { children: entry.query }),
          /* @__PURE__ */ jsx("span", { className: "text-xs text-muted-foreground", children: new Date(entry.timestamp).toLocaleDateString() })
        ]
      },
      entry.query
    )) }) })
