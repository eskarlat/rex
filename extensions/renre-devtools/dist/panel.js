...
function CardDescription({ className, ref, ...props }) {
  return /* @__PURE__ */ jsx("div", { ref, className: cn("text-sm text-muted-foreground", className), ...props });
}
...
function CodeBlock({ code, language, className }) {
  return /* @__PURE__ */ jsx(Card, { className: cn(className), children: /* @__PURE__ */ jsx(CardContent, { className: "p-4", children: /* @__PURE__ */ jsx("pre", { className: "overflow-auto", children: /* @__PURE__ */ jsx("code", { className: "font-mono text-sm", "data-language": language, children: code }) }) }) });
}
...
function EmptyState({ title, description, icon, className }) {
  return /* @__PURE__ */ jsxs("div", { className: cn("flex flex-col items-center justify-center py-12 text-center", className), children: [
...
function BrowserDevtoolsPanel({ sdk, extensionName }) {
  const extName = extensionName ?? "renre-devtools";
  const [chromeInstalled, setChromeInstalled] = useState(sdk ? null : true);
  ...
  const runTool = useCallback(
    async (tool, args = {}) => {
      ...
      try {
        ...
        const detail = err instanceof Error && "body" in err ? err.body.error ?? err.message : err instanceof Error ? err.message : `Failed to execute ${tool}`;
...
${result}`, timestamp: Date.now() }
  ...
  if (chromeInstalled === false) {
    return /* @__PURE__ */ jsx("div", { className: "flex flex-col gap-4", children: /* @__PURE__ */ jsx(
      Panel,
      {
        ...
        children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-3", children: [
          /* @__PURE__ */ jsxs("div", { className: "rounded-md border border-amber-500/30 bg-amber-500/10 p-4 text-sm", children: [
            /* @__PURE__ */ jsx("p", { className: "font-medium text-amber-600 dark:text-amber-400 mb-1", children: "Chrome not found" }),
            /* @__PURE__ */ jsx("p", { className: "text-muted-foreground text-xs", children: "Puppeteer requires a Chrome browser to be installed. Click the button below to install it via the terminal." })
          ] }),
          /* @__PURE__ */ jsx(
            "button",
            {
              ...
              children: installing ? "Installing Chrome..." : "Install Chrome"
            }
          ),
          installing && /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground", children: "Installation is running in the terminal. This may take a minute..." })
        ] })
      }
    ) });
  }
  if (chromeInstalled === null) {
    return /* @__PURE__ */ jsx("div", { className: "flex flex-col gap-4", children: /* @__PURE__ */ jsx(
      Panel,
      {
        ...
        children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 text-sm text-muted-foreground", children: [
          /* @__PURE__ */ jsx("span", { className: "inline-block h-2 w-2 rounded-full bg-blue-400 animate-pulse" }),
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-4", children: [
    /* @__PURE__ */ jsx(
      Panel,
      {
        ...
        children: /* @__PURE__ */ jsxs("div", { className: "text-sm text-muted-foreground space-y-2", children: [
          /* @__PURE__ */ jsx("p", { children: "This extension launches a real browser window you can see and interact with. Use the controls below to navigate, inspect pages, take screenshots, and run JavaScript." }),
          /* @__PURE__ */ jsx("p", { children: "LLM skills are available for automated debugging \u2014 the AI can navigate pages, click elements, fill forms, inspect the DOM, and capture screenshots on your behalf." }),
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5 mt-2", children: [
            ...
            /* @__PURE__ */ jsx("span", { className: "text-xs", children: crashed ? "Browser crashed" : browserRunning ? "Browser running" : "Browser stopped" }),
            pageTitle && /* @__PURE__ */ jsxs("span", { className: "text-xs text-muted-foreground ml-1", children: [
              "\u2014 ",
    ...
    /* @__PURE__ */ jsx(Panel, { title: "Browser Control", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-3", children: [
      /* @__PURE__ */ jsx("div", { className: "flex gap-2", children: !browserRunning ? /* @__PURE__ */ jsx(
        "button",
        {
          ...
          children: loading ? "Starting..." : "Open Browser"
        }
      ) : /* @__PURE__ */ jsx(
        "button",
        {
          ...
          children: "Stop Browser"
        }
      ) }),
      currentUrl && /* @__PURE__ */ jsxs("div", { className: "text-xs text-muted-foreground", children: [
        pageTitle && /* @__PURE__ */ jsxs("span", { className: "font-medium", children: [
          pageTitle,
          " \u2014 "
        ] }),
        "Current: ",
        /* @__PURE__ */ jsx("code", { className: "bg-muted px-1 rounded", children: currentUrl })
      ] })
    ] }) }),
    browserRunning && /* @__PURE__ */ jsx(Panel, { title: "Navigate", children: /* @__PURE__ */ jsxs("div", { className: "flex gap-2", children: [
      /* @__PURE__ */ jsx(
        "input",
        {
          type: "text",
    ...
    browserRunning && /* @__PURE__ */ jsx(Panel, { title: "Actions", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap gap-2", children: [
      /* @__PURE__ */ jsx(
        "button",
        {
    ...
    screenshotData && /* @__PURE__ */ jsx(Panel, { title: "Screenshot", children: /* @__PURE__ */ jsx("div", { className: "rounded-md border border-input overflow-hidden", children: /* @__PURE__ */ jsx(
      "img",
      {
    ...
    browserRunning && /* @__PURE__ */ jsx(Panel, { title: "JavaScript Console", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-2", children: [
    ...
    consoleLogs.length > 0 && /* @__PURE__ */ jsx(Panel, { title: "Console Output", children: /* @__PURE__ */ jsx("div", { className: "flex flex-col gap-1 max-h-64 overflow-y-auto", children: consoleLogs.map((log, index2) => /* @__PURE__ */ jsxs(
      "div",
      {
        className: "flex items-start gap-2 text-xs font-mono text-muted-foreground",
        children: [
          /* @__PURE__ */ jsx("span", { className: "text-[10px] opacity-50 shrink-0", children: new Date(log.timestamp).toLocaleTimeString() }),
          /* @__PURE__ */ jsx("pre", { className: "whitespace-pre-wrap break-all", children: log.text })
        ]
      },
      `${log.timestamp}-${index2}`
    )) }) }),
    crashed && /* @__PURE__ */ jsxs("div", { className: "rounded-md border border-destructive/50 bg-destructive/10 p-4 text-sm", children: [
      /* @__PURE__ */ jsx("p", { className: "font-medium text-destructive mb-2", children: "Browser crashed or became unreachable." }),
      /* @__PURE__ */ jsx(
        "button",
        {
          ...
          disabled: loading || !sdk,
          className: "inline-flex h-9 items-center justify-center rounded-md bg-primary px-4 text-sm font-medium text-primary-foreground shadow hover:bg-primary/90 disabled:opacity-50 disabled:pointer-events-none",
          children: "Restart Browser"
        }
      )
    ] }),
    !browserRunning && !error && !crashed && /* @__PURE__ */ jsx(
      EmptyState,
      {
    ...
    error && /* @__PURE__ */ jsx("div", { className: "rounded-md border border-destructive/50 bg-destructive/10 p-3 text-sm text-destructive", children: error })
  ] });
}
export {
  BrowserDevtoolsPanel as default
};
