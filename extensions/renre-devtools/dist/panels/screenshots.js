...
// src/ui/components/DeleteDialog.tsx
function DeleteDialog({ target, deleting, onClose, onConfirm }) {
  return /* @__PURE__ */ jsx(Dialog2, { open: !!target, onOpenChange: onClose, children: /* @__PURE__ */ jsxs(DialogContent2, { children: [
    /* @__PURE__ */ jsxs(DialogHeader, { children: [
      /* @__PURE__ */ jsx(DialogTitle2, { children: "Delete Screenshot" }),
      /* @__PURE__ */ jsxs(DialogDescription2, { children: [
    ...
    /* @__PURE__ */ jsxs(DialogFooter, { children: [
      /* @__PURE__ */ jsx(Button, { variant: "outline", onClick: onClose, disabled: deleting, children: "Cancel" }),
      /* @__PURE__ */ jsxs(Button, { variant: "destructive", onClick: onConfirm, disabled: deleting, children: [
        deleting ? /* @__PURE__ */ jsx(Spinner, {}) : null,
        " Delete"
      ] })
    ] })
  ] }) });
...
// src/ui/components/PreviewDialog.tsx
function buildDescription(screenshot) {
  ...
  return [urlPart, timePart].filter(Boolean).join(" \xB7 ");
}
function PreviewContent({ loading, dataUrl, alt }) {
  if (loading) return /* @__PURE__ */ jsx(Spinner, {});
  if (dataUrl) {
    return /* @__PURE__ */ jsx("img", { src: dataUrl, alt, style: { maxWidth: "100%", maxHeight: "70vh", objectFit: "contain" } });
  }
  return /* @__PURE__ */ jsx("span", { children: "Failed to load preview" });
}
function PreviewDialog({ screenshot, dataUrl, loading, onClose }) {
  return /* @__PURE__ */ jsx(Dialog2, { open: !!screenshot, onOpenChange: onClose, children: /* @__PURE__ */ jsxs(DialogContent2, { style: { maxWidth: "90vw", maxHeight: "90vh" }, children: [
    /* @__PURE__ */ jsxs(DialogHeader, { children: [
      /* @__PURE__ */ jsx(DialogTitle2, { children: screenshot?.filename }),
      /* @__PURE__ */ jsx(DialogDescription2, { children: buildDescription(screenshot) })
    ] }),
    /* @__PURE__ */ jsx("div", { style: { display: "flex", justifyContent: "center", alignItems: "center", minHeight: "200px" }, children: /* @__PURE__ */ jsx(PreviewContent, { loading, dataUrl, alt: screenshot?.filename ?? "Screenshot" }) })
  ] }) });
}

// src/ui/components/ScreenshotCard.tsx
function Thumbnail({ src, alt }) {
  if (src) {
    return /* @__PURE__ */ jsx("img", { src, alt, style: { width: "100%", height: "100%", objectFit: "cover" } });
  }
  return /* @__PURE__ */ jsx(Spinner, {});
}
function ScreenshotCard({ ss, thumbnail, onPreview, onDelete }) {
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      onClick: onPreview,
      children: [
        /* @__PURE__ */ jsx("div", { style: { aspectRatio: "16/9", background: "var(--muted, #1e1e1e)", display: "flex", alignItems: "center", justifyContent: "center", overflow: "hidden" }, children: /* @__PURE__ */ jsx(Thumbnail, { src: thumbnail, alt: ss.filename }) }),
        /* @__PURE__ */ jsxs("div", { style: { padding: "8px" }, children: [
          /* @__PURE__ */ jsx("div", { style: { fontSize: "12px", fontWeight: 600, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }, children: ss.filename }),
          /* @__PURE__ */ jsx("div", { style: { fontSize: "11px", color: "var(--muted-foreground, #94a3b8)", marginTop: "2px" }, children: new Date(ss.timestamp).toLocaleString() }),
          /* @__PURE__ */ jsx("div", { style: { marginTop: "4px" }, children: /* @__PURE__ */ jsx(Button, { variant: "ghost", size: "sm", onClick: (e) => {
            e.stopPropagation();
            onDelete();
          }, children: "Delete" }) })
        ] })
...
// src/ui/hooks/use-thumbnails.ts
init_react();
function useThumbnails(sdk, screenshots) {
  const [thumbnails, setThumbnails] = useState({});
  useEffect(() => {
    for (const ss of screenshots) {
      if (thumbnails[ss.path]) continue;
      void sdk.exec.run("renre-devtools:screenshot-read", { path: ss.path }).then((result) => {
  ...
  const clearThumbnail = useCallback((path) => {
    setThumbnails((prev) => {
      const next = { ...prev };
      delete next[path];
      return next;
...
function ScreenshotsPanel({ sdk }) {
  ...
  const loadScreenshots = useCallback(async () => {
    ...
    setLoading(true);
    try {
      const result = await sdk.exec.run("renre-devtools:screenshot-list");
      const data = JSON.parse(result.output);
  ...
  const handlePreview = useCallback(async (meta) => {
    ...
    try {
      const result = await sdkRef.exec.run("renre-devtools:screenshot-read", { path: meta.path });
      setPreviewDataUrl(JSON.parse(result.output).dataUrl);
    } catch {
  ...
  const handleDelete = useCallback(async () => {
    ...
    setDeleting(true);
    try {
      await sdkRef.exec.run("renre-devtools:screenshot-delete", { path: deleteTarget.path });
  ...
  if (loading) {
    return /* @__PURE__ */ jsx("div", { style: { display: "flex", justifyContent: "center", padding: "48px" }, children: /* @__PURE__ */ jsx(Spinner, {}) });
  }
  if (screenshots.length === 0) {
    return /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsxs(CardContent, { style: { padding: "48px", textAlign: "center" }, children: [
      /* @__PURE__ */ jsx("h3", { style: { margin: "0 0 8px" }, children: "No Screenshots" }),
      /* @__PURE__ */ jsx("p", { style: { color: "var(--muted-foreground, #94a3b8)", margin: 0 }, children: "Take a screenshot from the Overview panel to see it here." })
    ] }) });
  }
  return /* @__PURE__ */ jsxs("div", { style: { display: "flex", flexDirection: "column", gap: "16px" }, children: [
    /* @__PURE__ */ jsxs(Card, { children: [
      ...
      /* @__PURE__ */ jsx(CardContent, { children: /* @__PURE__ */ jsx("div", { style: { display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(200px, 1fr))", gap: "12px" }, children: screenshots.map((ss) => /* @__PURE__ */ jsx(
        ScreenshotCard,
        {
          ss,
          thumbnail: thumbnails[ss.path],
