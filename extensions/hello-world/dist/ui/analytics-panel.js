...
export default function AnalyticsPanel({ sdk, extensionName }) {
    ...
    return (_jsxs("div", { className: "flex flex-col gap-4", children: [_jsx(Panel, { title: "Scheduled Tasks", description: `Active scheduled tasks for ${extName}.`, children: _jsxs("div", { className: "flex flex-col gap-3", children: [_jsx("button", { onClick: () => {
                            ...
                            })) })) : (_jsx("p", { className: "text-sm text-muted-foreground", children: "No scheduled tasks. Use the main panel to start a cron task." }))] }) }), _jsx(Panel, { title: "Debug Info", description: "Raw extension state for debugging.", children: _jsx(CodeBlock, { code: JSON.stringify({ extensionName: extName, taskCount: tasks.length, tasks }, null, 2) }) })] }));
}
