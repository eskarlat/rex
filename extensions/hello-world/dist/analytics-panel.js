...
// src/ui/analytics-panel.tsx
function AnalyticsPanel({ sdk, extensionName }) {
  ...
  useEffect(() => {
    if (!sdk) return;
    setLoading(true);
    sdk.scheduler.list().then((all) => setTasks(all.filter((t) => t.name === extName))).catch(() => setTasks([])).finally(() => setLoading(false));
  }, [sdk, extName]);
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-4", children: [
    /* @__PURE__ */ jsx(Panel, { title: "Scheduled Tasks", description: `Active scheduled tasks for ${extName}.`, children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-3", children: [
      /* @__PURE__ */ jsx(
        "button",
        {
          onClick: () => {
      ...
      ) : /* @__PURE__ */ jsx("p", { className: "text-sm text-muted-foreground", children: "No scheduled tasks. Use the main panel to start a cron task." })
    ] }) }),
    /* @__PURE__ */ jsx(Panel, { title: "Debug Info", description: "Raw extension state for debugging.", children: /* @__PURE__ */ jsx(
      CodeBlock,
      {
