...
// src/ui/panel.tsx
function HelloWorldPanel({ sdk, extensionName }) {
  ...
  async function handleGreet() {
    ...
    setLoading(true);
    try {
      const result = await sdk.exec.run(`${extName}:greet`, { name: name || void 0 });
      setGreeting(result.output);
      setHistory((prev) => [
        { name: name || "World", response: result.output, time: (/* @__PURE__ */ new Date()).toLocaleTimeString() },
        ...prev.slice(0, 9)
      ]);
    } catch {
  ...
  function handleToast() {
    ...
    sdk.ui.toast({
      ...
      description: `Greetings from ${extName} at ${(/* @__PURE__ */ new Date()).toLocaleTimeString()}`
    });
  }
  ...
  useEffect(() => {
    if (!cronTask) return;
    const interval = setInterval(pollTask, 2e3);
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-4", children: [
    /* @__PURE__ */ jsx(
      Panel,
      {
        ...
        children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-3", children: [
          /* @__PURE__ */ jsx(FormField, { label: "Name", children: /* @__PURE__ */ jsxs("div", { className: "flex gap-2", children: [
            /* @__PURE__ */ jsx(
              "input",
              {
                type: "text",
            ...
            /* @__PURE__ */ jsx(
              "button",
              {
                ...
                children: loading ? "Running..." : "Greet"
              }
            )
          ] }) }),
          greeting && /* @__PURE__ */ jsx(CodeBlock, { code: greeting })
        ] })
      }
    ),
    /* @__PURE__ */ jsx(
        ...
        children: /* @__PURE__ */ jsxs("div", { className: "flex gap-2", children: [
          ...
          /* @__PURE__ */ jsx(
            "button",
            {
              ...
              className: cronTask ? "inline-flex h-9 items-center justify-center rounded-md border border-destructive bg-destructive/10 px-4 text-sm font-medium text-destructive shadow-sm hover:bg-destructive/20 disabled:opacity-50" : "inline-flex h-9 items-center justify-center rounded-md border border-input bg-background px-4 text-sm font-medium shadow-sm hover:bg-accent hover:text-accent-foreground disabled:opacity-50",
              children: cronLoading ? "..." : cronTask ? "Stop Cron" : "Start Cron (every 3s)"
            }
          )
        ] })
      }
    ),
    /* @__PURE__ */ jsx(Panel, { title: "Extension Info", description: "View extension version and metadata.", children: /* @__PURE__ */ jsx(
      "button",
      {
        onClick: () => {
          handleInfo().catch(() => {
    ...
    /* @__PURE__ */ jsx(Panel, { title: "Commands", description: "Available CLI commands for this extension.", children: /* @__PURE__ */ jsx(
      DataTable,
      {
        columns: [
    ...
    history.length > 0 && /* @__PURE__ */ jsx(Panel, { title: "Greeting History", description: "Recent greetings from this session.", children: /* @__PURE__ */ jsx(
      DataTable,
      {
        columns: [
          { key: "time", label: "Time" },
