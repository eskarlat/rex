...
// src/ui/settings-panel.tsx
function SettingsPanel({ sdk, extensionName }) {
  ...
  useEffect(() => {
    if (!sdk) return;
    sdk.storage.get("custom-greeting").then((val) => {
      if (val) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-4", children: [
    /* @__PURE__ */ jsx(Panel, { title: "Extension Info", description: `View metadata and status for ${extName}.`, children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-3", children: [
      /* @__PURE__ */ jsx(
        "button",
        {
          onClick: () => {
          ...
          children: loading ? "Loading..." : "Load Info"
        }
      ),
      info && /* @__PURE__ */ jsx(CodeBlock, { code: info })
    ] }) }),
    /* @__PURE__ */ jsx(
      Panel,
      {
        ...
        children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-3", children: [
          /* @__PURE__ */ jsx(FormField, { label: "Greeting Message", children: /* @__PURE__ */ jsxs("div", { className: "flex gap-2", children: [
            /* @__PURE__ */ jsx(
              "input",
              {
                type: "text",
          ...
          savedGreeting && /* @__PURE__ */ jsxs("p", { className: "text-sm text-muted-foreground", children: [
            "Current: ",
            /* @__PURE__ */ jsx("span", { className: "font-medium text-foreground", children: savedGreeting })
          ] })
        ] })
      }
    )
