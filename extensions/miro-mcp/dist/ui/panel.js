...
export default function MiroPanel({ sdk, extensionName }) {
    ...
    return (_jsxs("div", { className: "flex flex-col gap-4", children: [_jsxs("div", { className: "rounded-lg border border-border p-6", children: [_jsx("h2", { className: "mb-2 text-xl font-semibold", children: "Miro MCP" }), _jsx("p", { className: "text-sm text-muted-foreground", children: "Miro integration \u2014 98 tools across 21 toolsets." }), _jsxs("div", { className: "mt-2 inline-flex items-center gap-1.5", children: [_jsx("span", { className: "inline-block h-2 w-2 rounded-full bg-[#FFD02F]" }), _jsx("span", { className: "text-xs text-muted-foreground", children: "MCP stdio transport" })] })] }), _jsxs("div", { className: "rounded-lg border border-border p-6", children: [_jsx("h3", { className: "mb-3 text-base font-medium", children: "Connection Status" }), _jsx("button", { onClick: () => {
