  ...
  return /* @__PURE__ */ jsxs("div", { style: { display: "flex", flexDirection: "column", gap: "1rem" }, children: [
    /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsx("h2", { style: { fontSize: "1.25rem", fontWeight: 600, marginBottom: "0.5rem" }, children: "Miro MCP" }),
          /* @__PURE__ */ jsx("p", { style: { color: "var(--muted-foreground, #6b7280)", fontSize: "0.875rem" }, children: "Miro integration \u2014 98 tools across 21 toolsets." }),
          /* @__PURE__ */ jsxs(
            "div",
            {
              style: {
