...
export function createOrganizationToolset(client) {
    const tools = [
        {
    ...
    const handlers = {
        ...
        miro_list_org_members: createHandler((args) => client.listOrgMembers(args['orgId'], args['query'])),
        miro_get_org_member: createHandler((args) => client.getOrgMember(args['orgId'], args['memberId'])),
        miro_get_audit_logs: createHandler((args) => client.getAuditLogs(args['orgId'], args['query'])),
    };
