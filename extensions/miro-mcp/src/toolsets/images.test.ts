...
describe('createImagesToolset', () => {
  ...
  it('create from file handler creates FormData and calls client', async () => {
    ...
    const formData = (client.createImageFromFile as ReturnType<typeof vi.fn>).mock
  ...
  it('update from file handler creates FormData and calls client', async () => {
    ...
    const formData = (client.updateImageFromFile as ReturnType<typeof vi.fn>).mock
  ...
  it('returns error result on failure', async () => {
    const client = createMockClient();
    (client.getImage as ReturnType<typeof vi.fn>).mockRejectedValue(new Error('Not found'));
    const toolset = createImagesToolset(client);
