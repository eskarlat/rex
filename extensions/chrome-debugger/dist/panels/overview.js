...
var R, react_default, useState, useEffect, useCallback, useMemo, useRef, useContext, useReducer, useId, useLayoutEffect, useInsertionEffect, useImperativeHandle, useDebugValue, useSyncExternalStore, useTransition, useDeferredValue, createContext, createElement, createRef, forwardRef, memo, lazy, Fragment2, Suspense, StrictMode, Component, Children, cloneElement, isValidElement, startTransition;
var init_react = __esm({
  "react-global:react"() {
    R = window.__RENRE_REACT__;
    react_default = R;
    ({
      useState,
      useEffect,
...
var require_react_dom_development = __commonJS({
  "../../node_modules/.pnpm/react-dom@19.2.4_react@19.2.4/node_modules/react-dom/cjs/react-dom.development.js"(exports) {
    ...
    (function() {
      ...
      var React = (init_react(), __toCommonJS(react_exports)), Internals = {
        d: {
          f: noop3,
          r: function() {
            throw Error(
...
var { jsx, jsxs, Fragment } = window.__RENRE_JSX_RUNTIME__;

// ../../packages/extension-sdk/dist/components/index.js
init_react();
init_react();
init_react();
init_react();
...
// ../../node_modules/.pnpm/lucide-react@0.468.0_react@19.2.4/node_modules/lucide-react/dist/esm/shared/src/utils.js
var toKebabCase = (string) => string.replace(/([a-z0-9])([A-Z])/g, "$1-$2").toLowerCase();
var mergeClasses = (...classes) => classes.filter((className, index2, array) => {
  return Boolean(className) && className.trim() !== "" && array.indexOf(className) === index2;
}).join(" ").trim();

// ../../node_modules/.pnpm/lucide-react@0.468.0_react@19.2.4/node_modules/lucide-react/dist/esm/Icon.js
init_react();

// ../../node_modules/.pnpm/lucide-react@0.468.0_react@19.2.4/node_modules/lucide-react/dist/esm/defaultAttributes.js
...
function Table({ className, ref, ...props }) {
  return /* @__PURE__ */ jsx("div", { className: "relative w-full overflow-auto", role: "region", children: /* @__PURE__ */ jsx("table", { ref, className: cn("w-full caption-bottom text-sm", className), ...props }) });
}
function TableHeader({ className, ref, ...props }) {
  return /* @__PURE__ */ jsx("thead", { ref, className: cn("[&_tr]:border-b", className), ...props });
}
...
var Portal = forwardRef((props, forwardedRef) => {
  ...
  return container ? import_react_dom.default.createPortal(/* @__PURE__ */ jsx(Primitive.div, { ...portalProps, ref: forwardedRef }), container) : null;
});
  ...
  return /* @__PURE__ */ jsxs(DialogPortal2, { children: [
    ...
    /* @__PURE__ */ jsxs(
      Content,
      {
        ...
        children: [
          children,
          /* @__PURE__ */ jsxs(Close, { className: "absolute right-4 top-4 rounded-sm opacity-70 transition-opacity hover:opacity-100 focus:outline-none focus:ring-[3px] focus:ring-ring/50 disabled:pointer-events-none data-[state=open]:bg-accent data-[state=open]:text-muted-foreground", children: [
...
function Spinner({ size: size4 = "md", className }) {
  const pixels = sizeMap[size4] ?? 24;
...
function Input({
  ...
  return /* @__PURE__ */ jsx(
    "input",
    {
      type,
      className: cn(
        "flex h-9 w-full rounded-md border border-input bg-background px-3 py-2 text-sm shadow-xs file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-[3px] focus-visible:ring-ring/50 disabled:cursor-not-allowed disabled:opacity-50",
        className
      ),
      ref,
      ...props
...
var use = react_exports[" use ".trim().toString()];
...
function isSlottable2(child) {
  return isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER2;
}
...
var Separator = forwardRef((props, forwardedRef) => {
...
var buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium shadow-xs transition-colors focus-visible:outline-none focus-visible:ring-[3px] focus-visible:ring-ring/50 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
...
function Button({
  ...
  return /* @__PURE__ */ jsx(Comp, { className: cn(buttonVariants({ variant, size: size4, className })), ref, ...props });
}
var NAME2 = "Label";
var Label = forwardRef((props, forwardedRef) => {
  return /* @__PURE__ */ jsx(
    Primitive2.label,
    {
      ...props,
...
var Select = (props) => {
  ...
  return /* @__PURE__ */ jsx(Root23, { ...popperScope, children: /* @__PURE__ */ jsxs(
    SelectProvider,
    {
      required,
      scope: __scopeSelect,
      ...
      disabled,
      children: [
        /* @__PURE__ */ jsx(Collection2.Provider, { scope: __scopeSelect, children: /* @__PURE__ */ jsx(
  ...
  (props, forwardedRef) => {
    ...
    if (!context.open) {
      ...
      return frag ? ReactDOM5.createPortal(
        /* @__PURE__ */ jsx(SelectContentProvider, { scope: props.__scopeSelect, children: /* @__PURE__ */ jsx(Collection2.Slot, { scope: props.__scopeSelect, children: /* @__PURE__ */ jsx("div", { children: props.children }) }) }),
        frag
      ) : null;
    }
...
var Slot3 = /* @__PURE__ */ createSlot("SelectContent.RemoveScroll");
...
var SelectViewport = forwardRef(
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsxs(Fragment, { children: [
      ...
      /* @__PURE__ */ jsx(Collection2.Slot, { scope: __scopeSelect, children: /* @__PURE__ */ jsx(
        Primitive.div,
        {
...
function Alert({
  ...
  return /* @__PURE__ */ jsx("div", { ref, role: "alert", className: cn(alertVariants({ variant }), className), ...props });
}
...
function AlertDescription({ className, ref, ...props }) {
  return /* @__PURE__ */ jsx("div", { ref, className: cn("text-sm [&_p]:leading-relaxed", className), ...props });
}
var badgeVariants = cva(
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold shadow-xs transition-colors focus:outline-none focus:ring-[3px] focus:ring-ring/50",
  {
    variants: {
      variant: {
...
var ToastProvider = (props) => {
  ...
  return /* @__PURE__ */ jsx(Collection3.Provider, { scope: __scopeToast, children: /* @__PURE__ */ jsx(
      ...
      if (viewport) {
        const handleKeyDown = (event) => {
          ...
          if (isTabKey) {
            ...
            if (focusFirst3(sortedCandidates.slice(index2 + 1))) {
              event.preventDefault();
            } else {
          ...
          hasToasts && /* @__PURE__ */ jsx(
            FocusProxy,
            {
              ...
              onFocusFromOutsideViewport: () => {
                ...
                focusFirst3(tabbableCandidates);
              }
            }
          ),
          /* @__PURE__ */ jsx(Collection3.Slot, { scope: __scopeToast, children: /* @__PURE__ */ jsx(Primitive.ol, { tabIndex: -1, ...viewportProps, ref: composedRefs }) }),
          hasToasts && /* @__PURE__ */ jsx(
            FocusProxy,
            {
...
var ToastImpl = forwardRef(
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsxs(Fragment, { children: [
      ...
      /* @__PURE__ */ jsx(ToastInteractiveProvider, { scope: __scopeToast, onClose: handleClose, children: ReactDOM6.createPortal(
        /* @__PURE__ */ jsx(Collection3.ItemSlot, { scope: __scopeToast, children: /* @__PURE__ */ jsx(
          Root,
          {
            asChild: true,
...
var ToastDescription = forwardRef(
  (props, forwardedRef) => {
...
var ToastAnnounceExclude = forwardRef((props, forwardedRef) => {
...
var TooltipContent = forwardRef(
  (props, forwardedRef) => {
    const portalContext = usePortalContext2(CONTENT_NAME5, props.__scopeTooltip);
        ...
        children: /* @__PURE__ */ jsxs(
          Content3,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsx(VisuallyHiddenContentContextProvider, { scope: __scopeTooltip, isInside: true, children: /* @__PURE__ */ jsx(Root9, { id: context.contentId, role: "tooltip", children: ariaLabel || children }) })
            ]
          }
        )
      }
...
// src/ui/components/BrowserControlsCard.tsx
function BrowserInfo({ statusData }) {
  const since = statusData.launchedAt ? ` \xB7 Since: ${new Date(statusData.launchedAt).toLocaleTimeString()}` : "";
  return /* @__PURE__ */ jsxs("div", { style: { marginTop: "12px", fontSize: "13px", color: "var(--muted-foreground, #94a3b8)" }, children: [
    "PID: ",
    statusData.pid,
    " \xB7 Port: ",
    statusData.port,
...
function BadgeLabel({ statusLoading, isRunning }) {
  if (statusLoading) return "Checking...";
  return isRunning ? "Running" : "Stopped";
}
function BrowserControlsCard({
  isRunning,
  statusData,
  statusLoading,
  chromeDisabled,
  ...
  return /* @__PURE__ */ jsxs(Card, { children: [
    /* @__PURE__ */ jsx(CardHeader, { children: /* @__PURE__ */ jsxs(CardTitle, { style: { display: "flex", alignItems: "center", gap: "8px" }, children: [
      "Browser",
      /* @__PURE__ */ jsx(Badge, { variant: isRunning ? "default" : "secondary", children: BadgeLabel({ statusLoading, isRunning }) })
    ] }) }),
    /* @__PURE__ */ jsxs(CardContent, { children: [
      /* @__PURE__ */ jsx("div", { style: { display: "flex", gap: "8px", flexWrap: "wrap" }, children: !isRunning ? /* @__PURE__ */ jsxs(Button, { onClick: onLaunch, disabled: actionLoading || chromeDisabled, children: [
        actionLoading ? /* @__PURE__ */ jsx(Spinner, {}) : null,
        " Launch Browser"
      ] }) : /* @__PURE__ */ jsxs(Fragment, { children: [
        /* @__PURE__ */ jsx(Button, { variant: "destructive", onClick: onClose, disabled: actionLoading, children: "Stop Browser" }),
        /* @__PURE__ */ jsx(Button, { variant: "outline", onClick: onScreenshot, disabled: actionLoading, children: "Screenshot" }),
        /* @__PURE__ */ jsxs(Button, { variant: "outline", onClick: onInspect, disabled: actionLoading || inspecting, children: [
          inspecting ? /* @__PURE__ */ jsx(Spinner, {}) : null,
          " ",
          inspectLabel
        ] })
      ] }) }),
      isRunning && statusData ? /* @__PURE__ */ jsx(BrowserInfo, { statusData }) : null
    ] })
  ] });
}

// src/ui/components/ChromeAlert.tsx
function ChromeAlert({ chromeCheck, onInstallClick }) {
  if (chromeCheck.found) return null;
  return /* @__PURE__ */ jsxs(Alert, { children: [
    /* @__PURE__ */ jsx(AlertTitle, { children: "Chrome Not Found" }),
    /* @__PURE__ */ jsxs(AlertDescription, { children: [
      "No Chrome or Chromium installation detected.",
      /* @__PURE__ */ jsx(Button, { variant: "outline", size: "sm", style: { marginLeft: "8px" }, onClick: onInstallClick, children: "Download Chromium" })
    ] })
  ] });
}

// src/ui/components/InspectedElement.tsx
function InspectedElement({ output }) {
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx(Separator2, {}),
    /* @__PURE__ */ jsxs(Card, { children: [
      /* @__PURE__ */ jsx(CardHeader, { children: /* @__PURE__ */ jsx(CardTitle, { children: "Inspected Element" }) }),
      /* @__PURE__ */ jsx(CardContent, { children: /* @__PURE__ */ jsx("pre", { style: { background: "var(--muted, #1e1e1e)", padding: "12px", borderRadius: "6px", overflow: "auto", maxHeight: "300px", fontSize: "13px", whiteSpace: "pre-wrap" }, children: output }) })
    ] })
  ] });
}

// src/ui/components/InstallDialog.tsx
function InstallDialog({ open, installing, onClose, onInstall }) {
  const buttonLabel = installing ? "Downloading..." : "Download";
  return /* @__PURE__ */ jsx(Dialog2, { open, onOpenChange: onClose, children: /* @__PURE__ */ jsxs(DialogContent2, { children: [
    /* @__PURE__ */ jsxs(DialogHeader, { children: [
      /* @__PURE__ */ jsx(DialogTitle2, { children: "Download Chromium" }),
      /* @__PURE__ */ jsx(DialogDescription2, { children: "Chromium (~200MB) will be downloaded via Puppeteer. This is a one-time setup." })
    ] }),
    /* @__PURE__ */ jsxs(DialogFooter, { children: [
      /* @__PURE__ */ jsx(Button, { variant: "outline", onClick: onClose, disabled: installing, children: "Cancel" }),
      /* @__PURE__ */ jsxs(Button, { onClick: onInstall, disabled: installing, children: [
        installing ? /* @__PURE__ */ jsx(Spinner, {}) : null,
        " ",
        buttonLabel
      ] })
    ] })
...
// src/ui/components/NavigateCard.tsx
init_react();
function NavigateCard({ onNavigate, actionLoading }) {
  const [url, setUrl] = useState("");
  const submit = () => {
    if (url.trim()) onNavigate(url.trim());
  };
  return /* @__PURE__ */ jsxs(Card, { children: [
    /* @__PURE__ */ jsx(CardHeader, { children: /* @__PURE__ */ jsx(CardTitle, { children: "Navigate" }) }),
    /* @__PURE__ */ jsx(CardContent, { children: /* @__PURE__ */ jsxs("div", { style: { display: "flex", gap: "8px" }, children: [
      /* @__PURE__ */ jsx(
        Input,
        {
          type: "text",
      ...
      /* @__PURE__ */ jsx(Button, { onClick: submit, disabled: actionLoading || !url.trim(), children: "Go" })
    ] }) })
  ] });
}

// src/ui/components/TabsCard.tsx
function TabsCard({ tabs, onSwitchTab }) {
  return /* @__PURE__ */ jsxs(Card, { children: [
    ...
    /* @__PURE__ */ jsx(CardContent, { children: /* @__PURE__ */ jsxs(Table, { children: [
      /* @__PURE__ */ jsx(TableHeader, { children: /* @__PURE__ */ jsxs(TableRow, { children: [
        /* @__PURE__ */ jsx(TableHead, { style: { width: "48px" }, children: "#" }),
        /* @__PURE__ */ jsx(TableHead, { children: "URL" }),
        /* @__PURE__ */ jsx(TableHead, { style: { width: "80px" }, children: "Action" })
      ] }) }),
      /* @__PURE__ */ jsx(TableBody, { children: tabs.map((tab) => /* @__PURE__ */ jsxs(TableRow, { children: [
        /* @__PURE__ */ jsx(TableCell, { children: tab.index }),
        /* @__PURE__ */ jsx(TableCell, { style: { fontSize: "13px", wordBreak: "break-all" }, children: tab.url }),
        /* @__PURE__ */ jsx(TableCell, { children: /* @__PURE__ */ jsx(Button, { variant: "ghost", size: "sm", onClick: () => onSwitchTab(tab.index), children: "Switch" }) })
      ] }, tab.index)) })
    ] }) })
  ] });
}

// src/ui/hooks/use-browser-actions.ts
init_react();
function useBrowserActions(sdk, runAction) {
  const handleLaunch = useCallback(() => {
    void runAction("launch").then(() => {
      sdk.notify({ title: "Browser Started", variant: "success" });
    });
  }, [sdk, runAction]);
  const handleClose = useCallback(() => {
    void runAction("close").then(() => {
      sdk.notify({ title: "Browser Stopped", variant: "info" });
    });
  }, [sdk, runAction]);
  const handleScreenshot = useCallback(() => {
    void runAction("screenshot");
  }, [runAction]);
  const handleNavigate = useCallback((u) => {
    void runAction("navigate", { url: u });
  }, [runAction]);
  const handleSwitchTab = useCallback((i) => {
    void runAction("tab", { index: i });
  }, [runAction]);
  return { handleLaunch, handleClose, handleScreenshot, handleNavigate, handleSwitchTab };
}

// src/ui/hooks/use-browser-status.ts
init_react();

// src/ui/hooks/use-polling.ts
init_react();
function usePolling(fn, intervalMs, enabled) {
...
// src/ui/hooks/use-browser-status.ts
function useBrowserStatus(sdk) {
  const fetchStatus = useCallback(async () => {
    if (!sdk) return { running: false };
    const result = await sdk.exec.run("chrome-debugger:status");
    return JSON.parse(result.output);
  }, [sdk]);
  return usePolling(fetchStatus, 3e3, !!sdk);
}

// src/ui/hooks/use-chrome-detection.ts
init_react();
function useChromeDetection(sdk) {
  const [chromeCheck, setChromeCheck] = useState(null);
  const [installDialogOpen, setInstallDialogOpen] = useState(false);
  const [installing, setInstalling] = useState(false);
  useEffect(() => {
    if (!sdk) return;
    sdk.exec.run("chrome-debugger:chrome-check").then((r2) => setChromeCheck(JSON.parse(r2.output))).catch(() => setChromeCheck({ found: false, canInstall: true }));
  }, [sdk]);
  const handleInstall = useCallback(() => {
    if (!sdk) return;
    setInstalling(true);
    void sdk.exec.run("chrome-debugger:chrome-install").then((r2) => {
    ...
    }).catch((e) => sdk.ui.toast({ title: "Installation failed", description: e instanceof Error ? e.message : String(e) })).finally(() => {
      setInstalling(false);
...
// src/ui/hooks/use-heartbeat.ts
init_react();
function useHeartbeat(sdk, isRunning) {
  useEffect(() => {
    if (!sdk || !isRunning) return;
    const timer = setInterval(() => {
      void sdk.exec.run("chrome-debugger:heartbeat");
    }, 3e4);
    return () => {
      clearInterval(timer);
    };
...
// src/ui/hooks/use-inspect.ts
init_react();
function useInspect(sdk) {
  ...
  const handleInspect = useCallback(() => {
    ...
    void sdk.exec.run("chrome-debugger:inspect").then(() => sdk.exec.run("chrome-debugger:selected")).then((r2) => setSelectedElement(r2.output)).catch((e) => sdk.ui.toast({ title: "Inspect failed", description: e instanceof Error ? e.message : String(e) })).finally(() => setInspecting(false));
  }, [sdk]);
  return { inspecting, selectedElement, handleInspect };
}

// src/ui/hooks/use-run-action.ts
init_react();
function useRunAction(sdk, refreshStatus) {
...
// src/ui/panels/overview.tsx
function OverviewContent({ sdk }) {
  ...
  return /* @__PURE__ */ jsxs("div", { style: { display: "flex", flexDirection: "column", gap: "16px" }, children: [
    chromeNotFound ? /* @__PURE__ */ jsx(ChromeAlert, { chromeCheck, onInstallClick: () => setInstallDialogOpen(true) }) : null,
    /* @__PURE__ */ jsx(
      BrowserControlsCard,
      {
        isRunning,
        statusData,
        statusLoading,
        chromeDisabled: chromeNotFound,
        actionLoading,
        inspecting,
        onLaunch: actions.handleLaunch,
        onClose: actions.handleClose,
        onScreenshot: actions.handleScreenshot,
        onInspect: handleInspect
      }
    ),
    isRunning ? /* @__PURE__ */ jsx(NavigateCard, { onNavigate: actions.handleNavigate, actionLoading }) : null,
    isRunning && tabs.length > 0 ? /* @__PURE__ */ jsx(TabsCard, { tabs, onSwitchTab: actions.handleSwitchTab }) : null,
    selectedElement ? /* @__PURE__ */ jsx(InspectedElement, { output: selectedElement }) : null,
    /* @__PURE__ */ jsx(
      InstallDialog,
      {
...
function OverviewPanel({ sdk }) {
  if (!sdk) return /* @__PURE__ */ jsx("div", { style: { padding: "16px" }, children: "SDK not available" });
  return /* @__PURE__ */ jsx(OverviewContent, { sdk });
}
export {
  OverviewPanel as default
};
