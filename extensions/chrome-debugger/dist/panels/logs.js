...
var R, react_default, useState, useEffect, useCallback, useMemo, useRef, useContext, useReducer, useId, useLayoutEffect, useInsertionEffect, useImperativeHandle, useDebugValue, useSyncExternalStore, useTransition, useDeferredValue, createContext, createElement, createRef, forwardRef, memo, lazy, Fragment, Suspense, StrictMode, Component, Children, cloneElement, isValidElement, startTransition;
...
function TabsTrigger2({
  ...
  return /* @__PURE__ */ jsx(
    Trigger2,
    {
      ref,
      className: cn(
        "inline-flex items-center justify-center whitespace-nowrap rounded-sm px-3 py-1.5 text-sm font-medium shadow-xs transition-all focus-visible:outline-none focus-visible:ring-[3px] focus-visible:ring-ring/50 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:bg-background data-[state=active]:text-foreground data-[state=active]:shadow-sm",
        className
      ),
      ...props
    }
  ...
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsx(
      Primitive.span,
      {
        ...
        children: shouldShowPlaceholder(context.value) ? /* @__PURE__ */ jsx(Fragment2, { children: placeholder }) : children
      }
    );
  }
);
...
var ToastAnnounce = (props) => {
  ...
  return isAnnounced ? null : /* @__PURE__ */ jsx(Portal, { asChild: true, children: /* @__PURE__ */ jsx(VisuallyHidden, { ...announceProps, children: renderAnnounceText && /* @__PURE__ */ jsxs(Fragment2, { children: [
    context.label,
    " ",
    children
  ] }) }) });
...
// src/ui/components/ConsoleLogView.tsx
...
function ConsoleLogView({ entries, scrollRef }) {
  return /* @__PURE__ */ jsx("div", { ref: scrollRef, style: { maxHeight: "500px", overflow: "auto", fontFamily: "monospace", fontSize: "12px", background: "var(--muted, #1e1e1e)", borderRadius: "6px", padding: "8px" }, children: entries.length === 0 ? /* @__PURE__ */ jsx("div", { style: { color: "var(--muted-foreground, #94a3b8)", padding: "16px", textAlign: "center" }, children: "No console messages yet" }) : entries.map((entry, i) => /* @__PURE__ */ jsxs("div", { style: { padding: "2px 4px", borderBottom: "1px solid var(--border, #333)", color: levelColor(entry.level) }, children: [
    /* @__PURE__ */ jsx("span", { style: { color: "var(--muted-foreground, #94a3b8)", marginRight: "8px" }, children: new Date(entry.timestamp).toLocaleTimeString() }),
    /* @__PURE__ */ jsxs("span", { style: { marginRight: "8px", fontWeight: 600 }, children: [
      "[",
...
function FilterBar({ options: options2, active, onSelect }) {
  return /* @__PURE__ */ jsx("div", { style: { display: "flex", gap: "4px", marginLeft: "auto" }, children: options2.map((opt) => {
...
// src/ui/components/NetworkLogView.tsx
...
function NetworkLogView({ entries, scrollRef }) {
  return /* @__PURE__ */ jsx("div", { ref: scrollRef, style: { maxHeight: "500px", overflow: "auto" }, children: /* @__PURE__ */ jsxs(Table, { children: [
    ...
    /* @__PURE__ */ jsx(TableBody, { children: entries.length === 0 ? /* @__PURE__ */ jsx(TableRow, { children: /* @__PURE__ */ jsx(TableCell, { colSpan: 7, style: { textAlign: "center", color: "var(--muted-foreground, #94a3b8)" }, children: "No network requests yet" }) }) : entries.map((entry, i) => /* @__PURE__ */ jsxs(TableRow, { children: [
      /* @__PURE__ */ jsx(TableCell, { style: { fontSize: "12px", whiteSpace: "nowrap" }, children: new Date(entry.timestamp).toLocaleTimeString() }),
      /* @__PURE__ */ jsx(TableCell, { children: /* @__PURE__ */ jsx(Badge, { variant: "outline", children: entry.method }) }),
      /* @__PURE__ */ jsx(TableCell, { style: { color: statusColor(entry.status) }, children: entry.status }),
      /* @__PURE__ */ jsx(TableCell, { style: { fontSize: "12px" }, children: entry.type }),
      /* @__PURE__ */ jsx(TableCell, { style: { fontSize: "12px", maxWidth: "300px", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }, title: entry.url, children: entry.url }),
      /* @__PURE__ */ jsx(TableCell, { style: { fontSize: "12px", whiteSpace: "nowrap" }, children: formatBytes(entry.size) }),
      /* @__PURE__ */ jsxs(TableCell, { style: { fontSize: "12px", whiteSpace: "nowrap" }, children: [
        entry.duration,
        "ms"
      ] })
    ] }, i)) })
...
// src/ui/hooks/use-log-polling.ts
init_react();
function useLogPolling(sdk, isRunning, paused, levelFilter, methodFilter) {
  ...
  useEffect(() => {
    ...
    const poll = () => {
      void sdk.exec.run("chrome-debugger:console", { format: "json", limit: 200, ...levelFilter ? { level: levelFilter } : {} }).then((r2) => {
        const d = JSON.parse(r2.output);
  ...
  useEffect(() => {
    if (!isRunning || paused) return;
    const poll = () => {
      void sdk.exec.run("chrome-debugger:network", { format: "json", limit: 200, ...methodFilter ? { method: methodFilter } : {} }).then((r2) => {
        const d = JSON.parse(r2.output);
...
function LogsPanel({ sdk }) {
  ...
  const networkScrollRef = useRef(null);
  const sdkRef = sdk;
  const { consoleEntries, networkEntries, consoleTotalLines, networkTotalLines, clear } = useLogPolling(sdkRef, isRunning, paused, levelFilter, methodFilter);
  useEffect(() => {
  ...
  const handleClearLogs = useCallback(async () => {
    try {
      await sdkRef.exec.run("chrome-debugger:clear-logs");
      clear();
  ...
  if (!isRunning) {
    return /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsxs(CardContent, { style: { padding: "48px", textAlign: "center" }, children: [
      /* @__PURE__ */ jsx("h3", { style: { margin: "0 0 8px" }, children: "Browser Not Running" }),
      /* @__PURE__ */ jsx("p", { style: { color: "var(--muted-foreground, #94a3b8)", margin: 0 }, children: "Launch a browser from the Overview panel to see logs." })
    ] }) });
  }
  return /* @__PURE__ */ jsxs("div", { style: { display: "flex", flexDirection: "column", gap: "16px" }, children: [
    /* @__PURE__ */ jsxs("div", { style: { display: "flex", gap: "8px", alignItems: "center" }, children: [
      /* @__PURE__ */ jsx(Button, { variant: paused ? "default" : "outline", size: "sm", onClick: () => setPaused(!paused), children: paused ? "Resume" : "Pause" }),
      /* @__PURE__ */ jsx(Button, { variant: "outline", size: "sm", onClick: () => void handleClearLogs(), children: "Clear" }),
      paused ? /* @__PURE__ */ jsx(Badge, { variant: "secondary", children: "Paused" }) : null
    ] }),
    /* @__PURE__ */ jsxs(Tabs2, { value: activeTab, onValueChange: setActiveTab, children: [
      /* @__PURE__ */ jsxs(TabsList2, { children: [
        /* @__PURE__ */ jsxs(TabsTrigger2, { value: "console", children: [
          "Console (",
          consoleTotalLines,
          ")"
        ] }),
        /* @__PURE__ */ jsxs(TabsTrigger2, { value: "network", children: [
          "Network (",
          networkTotalLines,
          ")"
        ] })
      ] }),
      /* @__PURE__ */ jsx(TabsContent2, { value: "console", children: /* @__PURE__ */ jsxs(Card, { children: [
        /* @__PURE__ */ jsx(CardHeader, { children: /* @__PURE__ */ jsxs(CardTitle, { style: { display: "flex", alignItems: "center", gap: "8px" }, children: [
          "Console",
          /* @__PURE__ */ jsx(FilterBar, { options: ["all", "log", "warning", "error"], active: levelFilter, onSelect: setLevelFilter })
        ] }) }),
        /* @__PURE__ */ jsx(CardContent, { children: /* @__PURE__ */ jsx(ConsoleLogView, { entries: consoleEntries, scrollRef: consoleScrollRef }) })
      ] }) }),
      /* @__PURE__ */ jsx(TabsContent2, { value: "network", children: /* @__PURE__ */ jsxs(Card, { children: [
        /* @__PURE__ */ jsx(CardHeader, { children: /* @__PURE__ */ jsxs(CardTitle, { style: { display: "flex", alignItems: "center", gap: "8px" }, children: [
          "Network",
          /* @__PURE__ */ jsx(FilterBar, { options: ["all", "GET", "POST", "PUT", "DELETE"], active: methodFilter, onSelect: setMethodFilter })
        ] }) }),
        /* @__PURE__ */ jsx(CardContent, { children: /* @__PURE__ */ jsx(NetworkLogView, { entries: networkEntries, scrollRef: networkScrollRef }) })
      ] }) })
    ] })
  ] });
}
