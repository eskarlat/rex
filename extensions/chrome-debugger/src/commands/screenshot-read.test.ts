...
const TEST_DIR = join(tmpdir(), 'chrome-debugger-ssread-test-' + Date.now().toString());
const SCREENSHOT_DIR = join(TEST_DIR, '.renre-kit', 'storage', 'chrome-debugger', 'screenshots');
