...
function FigmaPanel({ sdk, extensionName }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-4", children: [
    /* @__PURE__ */ jsx(Panel, { title: "Figma", description: "Figma design file tools via MCP server.", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5 text-xs text-muted-foreground", children: [
      /* @__PURE__ */ jsx("span", { className: "inline-block h-2 w-2 rounded-full bg-green-500" }),
      "MCP SSE transport"
    ] }) }),
    /* @__PURE__ */ jsx(Panel, { title: "File Browser", children: /* @__PURE__ */ jsx("div", { className: "flex flex-col gap-3", children: /* @__PURE__ */ jsx(FormField, { label: "File Key", children: /* @__PURE__ */ jsxs("div", { className: "flex gap-2", children: [
      /* @__PURE__ */ jsx(
        "input",
        {
          type: "text",
      ...
      /* @__PURE__ */ jsx(
        "button",
        {
          ...
          children: loading && !fileData ? "Loading..." : "Get File"
        }
      )
    ] }) }) }) }),
    fileData && /* @__PURE__ */ jsx(Panel, { title: "File Info", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-3", children: [
      /* @__PURE__ */ jsx("div", { className: "flex gap-2", children: /* @__PURE__ */ jsx(
        "button",
        {
          ...
          children: loading && !comments ? "Loading..." : "Get Comments"
        }
      ) }),
      /* @__PURE__ */ jsx(CodeBlock, { code: fileData })
    ] }) }),
    comments && /* @__PURE__ */ jsx(Panel, { title: "Comments", children: /* @__PURE__ */ jsx(CodeBlock, { code: comments }) }),
    ...
    history.length > 0 && /* @__PURE__ */ jsx(Panel, { title: "Recent Files", children: /* @__PURE__ */ jsx("div", { className: "flex flex-col gap-1.5", children: history.map((entry) => /* @__PURE__ */ jsxs(
      "button",
      {
        ...
        children: [
          /* @__PURE__ */ jsx("span", { children: entry.fileName }),
          /* @__PURE__ */ jsx("code", { className: "text-xs text-muted-foreground", children: entry.fileKey })
        ]
      },
      entry.fileKey
    )) }) })
