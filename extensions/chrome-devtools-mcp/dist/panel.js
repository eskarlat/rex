...
var Table = forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsx("div", { className: "relative w-full overflow-auto", role: "region", children: /* @__PURE__ */ jsx(
  "table",
  {
    ref,
...
var DialogContent2 = forwardRef(({ className, children, ...props }, ref) => /* @__PURE__ */ jsxs(DialogPortal2, { children: [
...
var DialogTitle2 = forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsx(
  Title,
  {
    ref,
    className: cn(
...
var DialogDescription2 = forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsx(
  Description,
  {
    ref,
    className: cn("text-sm text-muted-foreground", className),
...
function ChromeDevToolsPanel({ sdk, extensionName }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-4", children: [
    /* @__PURE__ */ jsx(
      Panel,
      {
        ...
        children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5 text-xs text-muted-foreground", children: [
          /* @__PURE__ */ jsx("span", { className: "inline-block h-2 w-2 rounded-full bg-green-500" }),
          "MCP stdio transport"
        ] })
      }
    ),
    /* @__PURE__ */ jsx(Panel, { title: "Browser Actions", children: /* @__PURE__ */ jsx("div", { className: "flex flex-wrap gap-1.5", children: BROWSER_ACTIONS.map((action) => /* @__PURE__ */ jsx(
      "button",
      {
        onClick: () => handleSelectAction(action.id),
        title: action.description,
        className: `inline-flex items-center rounded-md px-3 py-1.5 text-xs font-medium transition-colors ${selectedAction === action.id ? "bg-primary text-primary-foreground" : "border border-input bg-background hover:bg-accent hover:text-accent-foreground"}`,
        children: action.label
      },
      action.id
    )) }) }),
    activeAction && /* @__PURE__ */ jsx(Panel, { title: activeAction.label, description: activeAction.description, children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-3", children: [
      activeAction.fields.map((field) => /* @__PURE__ */ jsx(FormField, { label: field.label, children: /* @__PURE__ */ jsx(
        "input",
        {
          type: "text",
      ...
      /* @__PURE__ */ jsx(
        "button",
        {
          ...
          children: running ? "Running..." : `Run ${activeAction.label}`
        }
      )
    ] }) }),
    /* @__PURE__ */ jsx(Panel, { title: "Action Log", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-2", children: [
      actionLog.length === 0 && /* @__PURE__ */ jsx("p", { className: "text-sm text-muted-foreground", children: "No actions yet. Select a browser action above to get started." }),
      actionLog.map((entry) => /* @__PURE__ */ jsxs(
        "div",
        {
              ...
              "button",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                    /* @__PURE__ */ jsx("span", { className: `inline-block h-2 w-2 shrink-0 rounded-full ${statusDot(entry.status)}` }),
                    /* @__PURE__ */ jsx("span", { className: "font-medium", children: entry.label }),
                    Object.values(entry.params).some((v) => v) && /* @__PURE__ */ jsx("span", { className: "text-xs text-muted-foreground truncate max-w-[200px]", children: Object.values(entry.params).filter(Boolean).join(", ") })
                  ] }),
                  /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                    /* @__PURE__ */ jsx("span", { className: "text-xs text-muted-foreground whitespace-nowrap", children: new Date(entry.timestamp).toLocaleTimeString() }),
                    /* @__PURE__ */ jsx("span", { className: "text-xs text-muted-foreground", children: expandedEntry === entry.id ? "\u25B2" : "\u25BC" })
                  ] })
                ]
              }
            ),
            expandedEntry === entry.id && /* @__PURE__ */ jsxs("div", { className: "border-t border-input p-2.5", children: [
              entry.output && /* @__PURE__ */ jsx("pre", { className: "mb-2 max-h-48 overflow-auto rounded bg-muted p-2 text-xs whitespace-pre-wrap", children: entry.output }),
              /* @__PURE__ */ jsx(
                "button",
                {
      ...
      actionLog.length > 0 && /* @__PURE__ */ jsx(
        "button",
        {
...
export {
  ChromeDevToolsPanel as default
};
